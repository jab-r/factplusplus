...
protected:	// constants
	...
	static const unsigned int redoForall = 1;
	static const unsigned int redoFunc = 2;
	static const unsigned int redoAtMost = 4;
	static const unsigned int redoIrr = 8;
		// Do NOT forget to update when new constant is added
	static const unsigned int redoEverything = redoForall | redoFunc | redoAtMost | redoIrr;
